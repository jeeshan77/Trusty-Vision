...
export default function HomepageExamples(props: ExamplesProps) {
  ...
  return (
    ...
    >
          ...
          <button
            ...
            className={`rounded-lg border px-4 py-2 text-sm font-medium transition-all 
              ${activeCategory === category
                ? 'border-primary bg-primary text-secondary scale-105'
                : 'border-primary/40 text-primary hover:bg-primary hover:text-secondary'}`}
          >
            {category}
          </button>
        ))}
      ...
      {/* ✅ Grid of Examples */}
      <div className="z-30 grid h-full w-full gap-10 
        ...
        {filteredExamples.map((example, index) => (
          <ExampleCard
            ...
            tags={example.tags}
            demo={example.demo}
            category={example.category} // ✅ use category from JSON
