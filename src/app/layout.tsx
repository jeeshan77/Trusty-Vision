...
export const metadata: Metadata = {
  ...
  description: "Trusty Vision offers expert web development, SEO, and digital solutions to boost your online presence and grow your business efficiently.",
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang='en'>
      <body className={`${inter.variable} ${coiny.variable} ${dongle.variable} ${exo2.variable} ${quicksand.variable} ${montserrat.variable} ${comfortaa.variable}`}>{children}</body>
    </html>
  );
}
