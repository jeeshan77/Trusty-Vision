  ...
  //         <RightBanner className='z-10 w-full px-5 md:w-1/2 md:px-10 -mt-20' />
  ...
  return (
    ...
    >
      <div className='z-10 flex h-full w-full flex-col items-center justify-center gap-10 border-b-4 border-primary pb-10 md:flex-row'>
        ...
        <div className='flex w-full flex-col md:flex-row items-center md:items-start gap-10'>
          <LeftBanner className='z-10 w-full gap-10 px-10 md:w-1/2' />
          <RightBanner className='z-10 w-full px-5 md:w-1/2 md:px-10 mt-0 md:-mt-20' />
        </div>
      </div>
    </div>
  );
