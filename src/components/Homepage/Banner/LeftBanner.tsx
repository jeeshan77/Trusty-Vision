...
export default function LeftBanner({ className }: { className?: string }) {
  return (
    ...
    >
      <div className="flex h-full flex-col items-center text-center md:items-end md:text-right">
        <div className="text-4xl font-extrabold leading-tight tracking-tight lg:text-6xl">
          Sites Built Different,
        </div>
        <div className="text-3xl font-bold tracking-tight lg:text-5xl">
          <span className="text-primary">{'Just'}</span> Like You!
        </div>
        <OrderNowButton className="mt-10 lg:mt-32 lg:w-1/2 mx-auto lg:ml-[20%]" />
      </div>
    </div>
